...
-- (The trigger will auto-create profiles rows)
...
insert into public.trips (id, name, currency, start_date, created_by, invite_code)
values (
...
insert into public.expenses (id, trip_id, title, amount, payer_id, category, date, split_mode, status, created_by)
values
...
insert into public.expense_shares (expense_id, user_id, share) values
...
insert into public.payments (trip_id, from_user_id, to_user_id, amount, date)
values (
  'c3333333-3333-3333-3333-333333333333',
  'b2222222-2222-2222-2222-222222222222',
  'a1111111-1111-1111-1111-111111111111',
